...
namespace Teacup
{
    class Program
    {
        ...
        {
            //Values to assign in the DrawString()
            string number = "";
            string Percent = "";
            ...
            {
                //date is not included default to yesterday
                Console.WriteLine("Usage: gentea infile outfile configfile  [date: mm/dd/yyyy]  ");

                return;
            }
            //Given a date by the user
            if (args.Length == 4)
            {
